...
'''def showCommunity(G, partition, pos):
    ...
    colors = ['#ff0000', '#00ff00', '#0000ff', '#ffff00', '#ff00ff', '#00ffff', '#800000', '#008000', '#000080',
              '#808000', '#800080', '#008080', '#c0c0c0', '#808080', '#ff99cc', '#ffcc99', '#cc99ff', '#99ccff',
              '#99ffcc', '#ff9999', '#99ff99', '#9999ff', '#ffff99', '#ff99ff', '#99ffff', '#993300', '#339900',
              '#003399', '#993399', '#339999', '#999933', '#993333', '#333399', '#999999', '#ff6666', '#66ff66',
              '#6666ff', '#ffff66', '#ff66ff', '#66ffff', '#660000', '#006600', '#000066', '#660066', '#006666']

    shapes = ['v', 'D', 'o', '^', '<', '>', 's', 'p', '*', 'h'] * 4 + ['H'] * 3
...
def showCommunity(G, partition, pos):
    ...
    for index, item in enumerate(partition):
        for nodeID in item:
            labels[nodeID] = nodeID  # 设置可视化label
            cluster[nodeID] = index  # 节点分区号
    ...
    dpi = 900
    plt.savefig('Louvain_graph.png', dpi=dpi)
    plt.axis('off')
    plt.show()
...
if __name__ == '__main__':
    ...
    obj = Graph()
    G1 = obj.createGraph("data/relation_result.txt")
